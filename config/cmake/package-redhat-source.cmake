...
if (UNIX)
    ...
    # Generate spec file
    devtemplate_configure_file(${DEV_CMAKE_NAME}_redhat_source_spec FALSE "${PROJECT_SOURCE_DIR}/config/template/redhat_source/spec" "${PROJECT_source_DIR}/redhat_source/${DEV_FILE_NAME}-${DEV_VERSION}.spec")
