...
if (NOT WIN32)
    # Generate manual
    devtemplate_configure_file(${DEV_CMAKE_NAME}_man FALSE "${PROJECT_SOURCE_DIR}/config/template/man.1" "${PROJECT_BINARY_DIR}/${DEV_FILE_NAME}.${DEV_CATEGORY}")
    ...
    add_custom_command(OUTPUT "${PROJECT_BINARY_DIR}/${DEV_FILE_NAME}.${DEV_CATEGORY}.gz"
        ...
        VERBATIM)
    add_custom_target(${DEV_CMAKE_NAME}_man_gzip ALL DEPENDS "${PROJECT_BINARY_DIR}/${DEV_FILE_NAME}.${DEV_CATEGORY}.gz")
endif()