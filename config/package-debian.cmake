...
devtemplate_configure_file(TARGET ${DEV_CMAKE_NAME}_control INPUT "${PROJECT_SOURCE_DIR}/config/template/control" OUTPUT "${PROJECT_BINARY_DIR}/debian/${DEV_FILE_NAME}/DEBIAN/control")
