...
devtemplate_configure_file(TARGET debian_control
    INPUT "${PROJECT_SOURCE_DIR}/config/template/control"
    OUTPUT "${PROJECT_BINARY_DIR}/debian/${DEV_FILE_NAME}/DEBIAN/control")

# Define pre-packaging target
add_custom_target(debian_package DEPENDS ${DEV_PACKAGE_TARGETS} debian_control)